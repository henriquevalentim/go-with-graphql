...
func (ec *executionContext) _Mutation_createCategory(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Category)
	fc.Result = res
	return ec.marshalOCategory2ᚖgithubᚗcomᚋdevfullcycleᚋgraphQLᚋgraphᚋmodelᚐCategory(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOCategory2ᚖgithubᚗcomᚋdevfullcycleᚋgraphQLᚋgraphᚋmodelᚐCategory(ctx context.Context, sel ast.SelectionSet, v *model.Category) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Category(ctx, sel, v)
